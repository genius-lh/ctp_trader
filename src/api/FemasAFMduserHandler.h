#ifndef _FEMAS_AF_MDUSER_HANDLER_H_
#define _FEMAS_AF_MDUSER_HANDLER_H_
...
typedef struct femas_af_mduser_api_cb_def femas_af_mduser_api_cb;

struct femas_af_mduser_api_cb_def{
...
class CFemasAFMduserHandler : public CUstpFtdcMduserSpi
{
public:
  // 构造函数，需要一个有效的指向CUstpFtdcMduserApi实例的指针
  CFemasAFMduserHandler(femas_af_mduser_api_cb *pUserCb, void * parent);
  ~CFemasAFMduserHandler();
...
private:
  femas_af_mduser_api_cb *m_pUserCb;
  void * m_parent;
