...
class CIBTraderHandler : public EWrapper
{
public:
  // 构造函数，需要一个有效的指向CUstpFtdcTraderApi实例的指针
  CIBTraderHandler(void * parent);
  ~CIBTraderHandler();
...
public:
  static Contract getContractById(const char* instrument);
};
