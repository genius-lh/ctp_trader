...
int main(int argc, char* argv[])
{
  ...
  pTraderApi->SubscribeMarketDataTopic (100, USTP_TERT_RESUME);
...
///订阅主题应答
void CFemasMduserHandler::OnRspSubscribeTopic(CUstpFtdcDisseminationField *pDissemination, CUstpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{

}

///主题查询应答
void CFemasMduserHandler::OnRspQryTopic(CUstpFtdcDisseminationField *pDissemination, CUstpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
