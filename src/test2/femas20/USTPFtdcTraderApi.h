...
public:
	...
	///报价查询应答
	virtual void OnRspQryQuote(CUstpFtdcRtnQuoteField *pRtnQuote, CUstpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
};
...
public:
	...
	///@return 创建出的UserApi
	static CUstpFtdcTraderApi *CreateFtdcTraderApi(const char *pszFlowPath = "",const bool bRunAtMaximalSpeed = false);
	...
	///报价查询请求
	virtual int ReqQryQuote(CUstpFtdcQryQuoteField *pQryQuote, int nRequestID) = 0;
protected:
	~CUstpFtdcTraderApi(){};
};
