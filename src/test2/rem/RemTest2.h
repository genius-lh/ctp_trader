...
class CRemTestHandler2 : public EESTraderEvent
{
public:
  CRemTestHandler2();
  virtual ~CRemTestHandler2();
	/// 连接消息的回调
...
public:
  ...
  void OrderInsert(const char* InstrumentID, int ExchangeID, char Direction, char OffsetFlag, double LimitPrice, int Volume);
  void OrderAction(int Quantity, long MarketOrderID);
