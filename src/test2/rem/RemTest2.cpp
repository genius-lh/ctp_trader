...
#define REM_TEST_LOG(...) info(__VA_ARGS__)
...
CRemTestHandler2::CRemTestHandler2()
{
...
void CRemTestHandler2::OnConnection(ERR_NO errNo, const char* pErrStr )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);

}

void CRemTestHandler2::OnDisConnection(ERR_NO errNo, const char* pErrStr )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);

}

void CRemTestHandler2::OnUserLogon(EES_LogonResponse* pLogon)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnRspChangePassword(EES_ChangePasswordResult nResult)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnQueryUserAccount(EES_AccountInfo * pAccoutnInfo, bool bFinish)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  if(!pAccoutnInfo){
    return;
...
void CRemTestHandler2::OnQueryAccountPosition(const char* pAccount, EES_AccountPosition* pAccoutnPosition, int nReqId, bool bFinish)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnQueryAccountBP(const char* pAccount, EES_AccountBP* pAccoutnPosition, int nReqId )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  REM_TEST_LOG(
    "pAccoutnPosition->pAccount=[%s]\n"
...
void CRemTestHandler2::OnQuerySymbol(EES_SymbolField* pSymbol, bool bFinish)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderAccept(EES_OrderAcceptField* pAccept )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderMarketAccept(EES_OrderMarketAcceptField* pAccept)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderReject(EES_OrderRejectField* pReject )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderMarketReject(EES_OrderMarketRejectField* pReject)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderExecution(EES_OrderExecutionField* pExec )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnOrderCxled(EES_OrderCxled* pCxled )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnCxlOrderReject(EES_CxlOrderRej* pReject )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnQueryTradeOrder(const char* pAccount, EES_QueryAccountOrder* pQueryOrder, bool bFinish  )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnQueryTradeOrderExec(const char* pAccount, EES_QueryOrderExecution* pQueryOrderExec, bool bFinish  )
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OnSymbolStatusReport(EES_SymbolStatus* pSymbolStatus)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::OrderInsert()
{
  char Temp[64];
...
void CRemTestHandler2::OrderInsert(const char* InstrumentID, int ExchangeID, char Direction, char OffsetFlag, double LimitPrice, int Volume)
{
  EES_SideType SideType;
  if('0' == OffsetFlag){
    if('0' == Direction){
...
void CRemTestHandler2::OrderAction()
{
  int Quantity;
...
void CRemTestHandler2::OrderAction(int Quantity, long MarketOrderID)
{
...
void CRemTestHandler2::QryOrder()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
...
void CRemTestHandler2::QryTrade()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  EESTraderApi* pTraderApi = (EESTraderApi*)m_Arg;
...
void CRemTestHandler2::QryUserInvestor()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  EESTraderApi* pTraderApi = (EESTraderApi*)m_Arg;
...
void CRemTestHandler2::QryInvestorAccount()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  EESTraderApi* pTraderApi = (EESTraderApi*)m_Arg;
...
void CRemTestHandler2::QryInstrument()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  EESTraderApi* pTraderApi = (EESTraderApi*)m_Arg;
...
void CRemTestHandler2::QryInvestorPosition()
{
  REM_TEST_LOG("%s\n", __FUNCTION__);
  EESTraderApi* pTraderApi = (EESTraderApi*)m_Arg;
...
void CRemTestHandler2::PrintOrder(void* data)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);

}

void CRemTestHandler2::PrintTrade(void* data)
{
  REM_TEST_LOG("%s\n", __FUNCTION__);

}

void CRemTestHandler2::ChangePassword()
{
  using namespace std;
...
void CRemTestHandler2::StatOrder()
{
  //TODO
}

void CRemTestHandler2::CancelAll()
{
  //TODO
}
